...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 EDU from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 EDU in block rewards plus fees, but
        ...
        # Send 100 EDU with subtract fee from amount
        ...
        # Sendmany 100 EDU with subtract fee from amount
