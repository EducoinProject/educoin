...
official/supported Docker Images found at https://hub.docker.com/r/educoinpay/educoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/educoinpay/educoind-develop/ when changing the above text**