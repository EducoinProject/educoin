...
This mechanism has been integrated into Bitcore-Node-Educoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/educoinpay/insight-api-educoin#web-socket-api](https://github.com/educoinpay/insight-api-educoin#web-socket-api)
* API: [https://github.com/educoinpay/insight-api-educoin#instantsend-transactions](https://github.com/educoinpay/insight-api-educoin#instantsend-transactions)
...
By default, the Educoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Educoin Core daemon:
