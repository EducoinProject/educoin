...
This document provides guidelines for internationalization of the Educoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `educoin_en.ts` remains unchanged.
