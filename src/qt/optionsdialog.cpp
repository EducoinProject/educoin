    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EDU-light"), QVariant("light"));
    ui->theme->addItem(QString("EDU-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("EDU-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("EDU-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("EDU-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EDU-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EDU-traditional"), QVariant("trad"));
