...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and educoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Educoin Core"));
    ...
    openAction->setStatusTip(tr("Open a educoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Educoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Educoin Core"); // default title
