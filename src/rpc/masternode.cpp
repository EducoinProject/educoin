...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Educoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "educoin",               "masternode",             &masternode,             true,  {} },
    { "educoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "educoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "educoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "educoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "educoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
