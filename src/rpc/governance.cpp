...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in educoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("educoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Educoin features */
    { "educoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "educoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "educoin",               "gobject",                &gobject,                true,  {} },
    { "educoin",               "voteraw",                &voteraw,                true,  {} },
